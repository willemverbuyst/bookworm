...
create_genres_table_sql = os.path.join(dirname, "../sql/genre/create_genre_table.sql")
...
insert_countries_sql = os.path.join(dirname, "../sql/country/insert_countries.sql")
insert_cities_sql = os.path.join(dirname, "../sql/city/insert_cities.sql")
insert_addresses_sql = os.path.join(dirname, "../sql/address/insert_addresses.sql")
insert_genres_sql = os.path.join(dirname, "../sql/genre/insert_genres.sql")
...
def seed_db():
    ...
    executeScriptsFromFile(create_genres_table_sql, cursor)
